...
lrn_rpart <- lrn("regr.rpart", maxdepth = 6)
rpart_train_predict <- lrn_rpart$train(rpart)
rpart_test_predict <- lrn_rpart$predict(rpart)
rpart_test_acc <- mean(rpart_test_predict$truth * rpart_test_predict$response > 0)
```
