...
# UMD obs start at later date #### Bryan - I'm not sure they do anymore. 
...
# Bryan - Convert UMD to an xts object and add a date index

UMD <- xts(UMD, order.by = index(HML_Devil.UMD))
