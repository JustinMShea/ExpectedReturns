...
#refactor by jiarui
# ts.regs.hml.test <- lapply(1:n.hml, function(i) {
...
ts.regs.hml.dev
#refactor by Jiarui
# ts.regs.hml.dev.test <- lapply(1:n.hml.d, function(i) {
#   data.test <- factors.data[, c(regrds[i, 2], hml.dev.regrs[i, ], 'DATE')]
#   y <- colnames(data.test)[1]
#   X <- hml.dev.regrs[i, ]
#   row.names(data.test) <-data.test$DATE
#   data.test$DATE <- NULL
