...
Let us begin with spanning regressions. It is important to notice that more often than not \textcite{hou-al-2018} construct factors included in the models studied (or alternative versions), whereas we only use factors data sets disseminated by respective authors themselves. This may lead to slight deviations or lack of results (for unavailable alternative versions data).
