...
At this time we are unable to study the "alternative Fama-French six-factor model", which has the RMWc cash-based factor in place of the RMW factor, because authors apparently dismissed its publication. Readers willing to study this model would thus need to construct it themselves.
