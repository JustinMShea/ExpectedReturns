...
XSMOM <- VME.Factors[, c('DATE', 'MOM.AA', 'MOMLS.VME.COM', 'MOMLS.VME.EQ', 'MOMLS.VME.FI', 'MOMLS.VME.FX', 'MOMLS.VME.US90')]
colnames(XSMOM) <- c('DATE', 'XSMOM.ALL', 'XSMOM.COM', 'XSMOM.EQ', 'XSMOM.FI', 'XSMOM.FX', 'XSMOM.US') # naming consistency
...
X <- c('XSMOM.ALL', 'XSMOM.COM', 'XSMOM.EQ', 'XSMOM.FI', 'XSMOM.FX', 'SMB', 'HML', 'MOM')
tsmom.div.all <- lapply(X, function(x) {
  plm::plm(
    formula(paste('TSMOM', x, sep='~')), 
