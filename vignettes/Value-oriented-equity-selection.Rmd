...
In the following we briefly review \textcite{asness-frazzini-2013} and reproduce 
this work thanks to replication data sets publicly available. Data are updated 
and maintained by AQR (www.aqr.com).
...
studied is the standard practice pioneered by fama-french-1992. It is the most 
widely used measure in the literature and as such it is also referred to as the 
"standard method". 
