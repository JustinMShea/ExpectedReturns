...
```{r Replication code for Exhibit 6 (p. 57)}
...
## Merge Factors and Assets data series available
...
## Replicate Exhibit 6 (p. 57): run time-series regressions
...
## TODO: all 'MRETX' missing are for VLO during 1993--1997
