...
# Get FF3 factors data
ff3.data.monthly <- GetFactors('FF3', freq='monthly')
ff3.data.monthly.dates <- zoo::index(ff3.data.monthly)
ff3.data.monthly <- as.data.frame(zoo::coredata(ff3.data.monthly))
ff3.data.monthly <- cbind(ff3.data.monthly.dates, ff3.data.monthly)
colnames(ff3.data.monthly)[1] <- 'DATE'

# match and merge FF3 factors data and stocks data
test.data.plm <- merge(factorDataSetDjia5Yrs, ff3.data.monthly)
