...
start <- which(ff3.data.monthly[, 'DATE'] == first(factorDataSetDjia5Yrs[, 'DATE']))
end <- which(ff3.data.monthly[, 'DATE'] == last(factorDataSetDjia5Yrs[, 'DATE']))
ff3.data.to.input <- ff3.data.monthly[start:end, ]
