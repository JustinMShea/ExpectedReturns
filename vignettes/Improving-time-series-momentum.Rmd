...
# Barplots
barplot(returns.pred, main='Newey-West t-stats TSMOM Lagged Returns', names.arg=as.character(lags))
barplot(sign.pred, main='Newey-West t-stats SIGN momentum signal', names.arg=as.character(lags))
# barplot(trend.pred, main='Newey-West t-stats TREND momentum signal', names.arg=as.character(lags))
```
