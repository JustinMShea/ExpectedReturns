...
We obtained data series analyzed mainly from Bloomberg (more information at https://www.bloomberg.com/markets/commodities), or FRED when otherwise stated. For reproducibility purposes, we made efforts to re-create a data set as similar as possible to the one studied by \textcite{baltas-kosowski-2012}. The data set consists of intra-day future prices at a 30 minutes frequency, next to the assets we also indicate the Bloomberg tickers, asset's sector and the Exchange where the symbol considered is traded at. First of all, 6 commodities futures among which Cocoa (`CC1`, Agricultural, ICE), Wheat (`W1`, Agricultural, CBOT), Crude Oil (`CL1`, Energy, CBOT), Natural Gas (`NG1`, Energy, Nymex), Copper (`HG1`, Industrial Metals, Comex) and Gold (`GC1`, Precious Metals, Comex); 2 equity indices, the S&P500 (`SPX`) and the Eurostoxx50 (`SX5E`); 2 FX rates: US Dollar Index and EUR/USD (both from FRED?); lastly, 2 interest rates: Eurodollar deposits and 10-year US T-Note.  
