...
## Merge FF4, VME Factors and VME.PORTF.RET
data <- merge(VME.PORTF.RET, FF4, by='DATE')
data <- merge(data, VME.FACTORS, by='DATE')

## Compute excess returns and merge
...
# Time-series regression with plm
# 
...
# TODO: straightforward, we only need 'betas'
```
