...
MKT.GLOBAL <- xts(HML_Devil.MKT$Global, HML_Devil.MKT$DATE)
...
VME.FACTORS_df <- as.data.frame(VME.FACTORS) # TODO: use xts, but this is a minimal fix to ensure document knits successfully as we use 'DATE' column lower down
