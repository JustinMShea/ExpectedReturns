...
# NOTE: Also, the 'MKT.RF' factor used here is Ken's one (US only). As argued, this 
# is inappropriate for the AMP global model, for which an international proxy have 
# to be used. Authors use MSCI WI.

# Time-series regressions
ts.reg <- plm::pmg(
  EXC.RET ~ MKT.RF + VAL.EVR + MOM.EVR,
