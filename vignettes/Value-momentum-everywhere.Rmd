...
parser.path <- system.file('parsers', 'Value--Devil-in-HMLs-Details.R',package='ExpectedReturns')
source(parser.path)
...
# NOTE: returns in decimal unit
path.parser <- system.file('parsers', 'MSCI-WI.R', package = 'ExpectedReturns')
source(path.parser)
...
## Import AQR data
# VME data
source(system.file('parsers', 'VME-Factors.R',package='ExpectedReturns'))
