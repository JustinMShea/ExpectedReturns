...
# function for computing annualized return, standard deviation, and sharpe
...
portfolios$MSCI.RF <- portfolios$MSCI.RET 
# - portfolios$RF
# Bonds factors data
...
portfolios2$EXC.RET.MISCI.RF <- portfolios2$MSCI.RF - portfolios2$RF
portfolios2$EXC.RET.VAL.EVR <- porfolios2$VAL.EVR - porfolios2$RF
